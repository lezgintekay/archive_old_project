<?php
include("../config.php");
    $sql = "SELECT * FROM aciklamaYazi ORDER BY id";
                ...
                <div class="row">
                    <div class="col-lg-12 mt-5 bg-white" style="min-height:500px;">
                        <form method="post" action="" enctype='multipart/form-data'>
                            <label for="">Araç Açıklama Yazısı</label>
                            ...
                            <table>
                                <thead>
                                   <tr>     
                                        ...
                                        <th style="text-align: center;">Araç Açıklaması </th>                         
                                ...
                                <tbody>
                                    ...
                                    <td><a href="aciklamaSil.php?id=<?php echo $rows['id']; ?>">Sil</a></td>
                                </tbody>
                                <?php 
                                }
                                ?>
