    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            if (gelenBilgi.equals("menudengeldim")) {
                ...
                val gorselSecmeArkaPlani  = BitmapFactory.decodeResource(context?.resources, R.drawable.add_image)
                imageView.setImageBitmap(gorselSecmeArkaPlani)
            }
            else {
                //daha önce eklenen yemeği görmeye geldi
    ...
    fun gorselSec(view: View){
        ...
        activity?.let {
            ...
            if(ContextCompat.checkSelfPermission(it.applicationContext,Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                ...
                //izin verilmiş, tekrar istemeye gerek yok
